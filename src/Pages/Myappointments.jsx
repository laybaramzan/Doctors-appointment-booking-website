...
const Myappointments = () => {
  ...
  return (
    <div>
      <p className="border-b pb-3 mt-12 font-medium text-zinc-700 border-gray-200">
        My Appointments
      </p>
      <div>
        {doctors.slice(0, 3).map((item, index) => (
          ...
          >
            ...
            <div className="text-zinc-600 text-sm flex-1">
            ...
            <div className="flex flex-col gap-2 justify-end">
              <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-[var(--color-primary)] hover:text-white transition-all duration-300">
                Pay Online
              </button>
